import { BoneIcon, ChevronRightIcon, SearchIcon, TvIcon, WifiIcon } from "lucide-react";
...
const items = [
  ...
  {
    link: "/maison-noix/find",
    icon: <SearchIcon />,
    title: "Help Me Find",
    description: "Where's the thing?! Find dishware, utensils, supplies, and more."
  },
  {
